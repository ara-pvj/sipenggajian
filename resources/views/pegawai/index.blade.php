...
<div class="flex justify-between items-center mb-8">
    ...
    <div>
        ...
        <p class="text-gray-500 mt-2">
            Kelola data guru dan staff SMP Roudhotul Mardhiyyah.
        </p>
...
<div class="flex gap-3 mb-6">
    ...
    <a href="{{ route('pegawai.index',['filter'=>'semua','search'=>$search]) }}"
       class="px-5 py-2 rounded-xl {{ $filter=='semua' ? 'bg-blue-600 text-white' : 'bg-gray-200' }}">
        Semua
    </a>

    <a href="{{ route('pegawai.index',['filter'=>'guru','search'=>$search]) }}"
       class="px-5 py-2 rounded-xl {{ $filter=='guru' ? 'bg-green-600 text-white' : 'bg-gray-200' }}">
        Guru
    </a>

    <a href="{{ route('pegawai.index',['filter'=>'staff','search'=>$search]) }}"
